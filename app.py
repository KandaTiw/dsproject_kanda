...
if page == "Homepage":
    ...
    st.image("https://audits.com.au/wp-content/uploads/2023/04/nag-blogpost-auditors-and-AI.jpg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
...
# Contact Us
    ...
    st.write("- Email: kanda@tni.ac.th")
